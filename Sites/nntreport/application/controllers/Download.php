<?php
/*=======================================================================
* TODO : Download Controller รายงานสรุปจำนวนผู้ใช้งานที่ Download ผ่านโปรแกรมประยุกต์
...
class Download extends CI_Controller
{
	...
	*-----------------------------------------------------------------*/
	...
	{
		$this->parser->parse( "summary_download.html", $this->ait->parseData );
	}
	...
	*-----------------------------------------------------------------*/
	public function datalist($page=1) {
		...
		$this->ait->pagination($result_array,"download/datalist/",$page);
		$this->ait->parseData +=  array(
	...
	*-----------------------------------------------------------------*/
	public function search($page=1){
		...
		$this->ait->pagination($result_array,"download/search/",$page);
		$this->ait->parseData +=  array(
			"result_array" => $result_array,
			"count_row"=>count($result_array)
		); 
